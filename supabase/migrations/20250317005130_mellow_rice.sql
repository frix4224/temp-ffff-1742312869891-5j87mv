...
DROP POLICY IF EXISTS "Service category items are viewable by authenticated users" ON service_category_items;
...
CREATE POLICY "Service category items are viewable by authenticated users"
